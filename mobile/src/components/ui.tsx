...
export function Screen({ children, style }: { children: React.ReactNode; style?: ViewStyle }) {
  ...
  return <View style={[{ flex: 1, backgroundColor: colors.bg, paddingHorizontal: 16, paddingTop: 8 }, style]}>{children}</View>;
}
...
export function Badge({
  ...
  return (
    <View style={{ borderWidth: 1, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4, borderColor: map[tone] }}>
      <Text style={{ fontSize: 11, fontWeight: '800', textTransform: 'uppercase', color: map[tone] }}>
        {label}
      </Text>
    </View>
  );
