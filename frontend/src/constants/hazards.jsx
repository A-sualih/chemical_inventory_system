...
export const GHS_PICTOGRAMS = {
  "Explosive": (
    <svg viewBox="0 0 100 100" className="hazard-svg" fill="none" stroke="currentColor" strokeWidth="2">
...
export const HAZARD_CLASSES = [
  { id: "Explosive", label: "Explosive", color: "hazard-color-orange", icon: GHS_PICTOGRAMS["Explosive"], description: "Unstable explosives, self-reactive substances, and organic peroxides." },
  { id: "Flammable", label: "Flammable", color: "hazard-color-red", icon: GHS_PICTOGRAMS["Flammable"], description: "Flammable gases, aerosols, liquids, and solids." },
  { id: "Oxidizer", label: "Oxidizing", color: "hazard-color-yellow", icon: GHS_PICTOGRAMS["Oxidizer"], description: "Oxidizing gases, liquids, and solids." },
  { id: "Compressed Gas", label: "Compressed Gas", color: "hazard-color-blue", icon: GHS_PICTOGRAMS["Compressed Gas"], description: "Gases under pressure." },
  { id: "Corrosive", label: "Corrosive", color: "hazard-color-blue-dark", icon: GHS_PICTOGRAMS["Corrosive"], description: "Skin corrosion/burns, eye damage, corrosive to metals." },
  { id: "Toxic", label: "Toxic", color: "hazard-color-gray-dark", icon: GHS_PICTOGRAMS["Toxic"], description: "Fatal or toxic if swallowed, in contact with skin or if inhaled." },
  { id: "Irritant", label: "Irritant", color: "hazard-color-red-light", icon: GHS_PICTOGRAMS["Irritant"], description: "Acute toxicity, skin/eye irritation, skin sensitization." },
  { id: "Health Hazard", label: "Health Hazard", color: "hazard-color-purple-dark", icon: GHS_PICTOGRAMS["Health Hazard"], description: "Carcinogenicity, mutagenicity, reproductive toxicity." },
  { id: "Environmental", label: "Environmental", color: "hazard-color-green-dark", icon: GHS_PICTOGRAMS["Environmental"], description: "Hazardous to the aquatic environment." }
];
