    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="relative z-10 flex flex-col gap-3">
                          ...
                          <div className="flex gap-2">
                             ...
                             <button 
                                ...
                                className={`flex-1 text-[10px] font-bold py-2 rounded-lg border transition-all uppercase tracking-widest ${
                                   u.status === 'Active' 
        ...
        <div className="space-y-8">
           ...
           <div className="bg-primary-600 p-10 rounded-[3rem] text-white shadow-2xl shadow-primary-900/40 border border-primary-500">
              ...
              <p className="text-primary-100 text-xs font-medium leading-relaxed">
                Role modifications are permanent and logged instantly. Changes may require users to re-login to synchronize session authority.
              </p>
           </div>
        </div>
      </div>
