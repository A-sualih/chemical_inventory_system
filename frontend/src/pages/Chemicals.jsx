                  ...
                  <td className="px-4 sm:px-8 py-4 sm:py-6">
                    <div className="flex items-center gap-4">
                      <div className="flex-1 min-w-[120px] mb-2 md:mb-0">
                        <span className={`inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.1em] px-3 py-1.5 rounded-lg border shadow-sm ${item.archived ? 'bg-red-50 text-red-700 border-red-100' :
